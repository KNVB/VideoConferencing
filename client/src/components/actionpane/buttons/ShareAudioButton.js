...
class ShareAudioButton extends Component {
    constructor(props){
        ...
        if (user.shareMedia.audio==="true"){
            this.state={shareAudioState:true}
        } else {
            this.state={shareAudioState:false}
        }
        this.switchAudio=()=>{
            this.setState({shareAudioState:!this.state.shareAudioState});
        }          
    }
    render(){
        if (this.state.shareAudioState){
            return (
                    <div className="btn d-flex flex-column just-content-center p-0" onClick={this.switchAudio}>
                        <div className="p-0">  
            ...
            return(
                    <div className="btn d-flex flex-column just-content-center p-0" onClick={this.switchAudio}>
                        <div className="p-0">     
                            <svg width="24" height="24" viewBox="0 0 24 24" className="bi bi-mic-mute-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
