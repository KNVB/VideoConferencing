...
class ShareVideoButton extends Component {
    constructor(props){
        ...
        if (user.shareMedia.video==="true"){
            this.state={shareVideoState:true}
        } else {
    ...
    render(){
        if (this.state.shareVideoState){
            return (
                    <div className="btn d-flex flex-column just-content-center p-0" onClick={this.switchVideo}>
                        <div className="p-0">
            ...
            return ( 
                        <div className="btn d-flex flex-column just-content-center p-0" onClick={this.switchVideo}>
                            <div className="p-0">
                                <svg width="24" height="24" viewBox="0 0 24 24" className="bi bi-camera-video-off" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
