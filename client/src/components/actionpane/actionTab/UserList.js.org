...
class UserList extends React.Component {
    constructor(props){
        ...
        this.state={"pendingReq":{},
                    "userList":this.props.meetingControl.userList};
    }
    componentDidMount(){
...
/*
    ...
    acceptRequest=()=>{
        this.props.meetingControl.acceptJoinRequest(this.props.meetingUtil.meetingId,this.state.pendingReq.id);
        /*
    ...
    rejectRequest=()=>{
        ...
        this.props.meetingControl.rejectJoinRequest(this.props.meetingUtil.meetingId,this.state.pendingReq.id);
        var userList=this.state.userList;
        delete userList[this.state.pendingReq.id];
        this.setState({reqUser:{},
                        "userList":userList,
